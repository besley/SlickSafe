...
{
    /// <summary>
    /// action filter used for authentication
    /// form cookie based request
    /// </summary>
    public class FormAuthCookieRequestAttribute : ActionFilterAttribute
    {
        /// <summary>
        /// user id
        /// </summary>
